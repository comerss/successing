...
/**
 * Created by human on 2017/7/27.
 */

public class HideSelectView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public HideSelectView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.pickerview_options_hide, contentContainer);
        // -----确定和取消按钮
