...
public class CameraUtils {
    ...
    public static File openCamera(Activity activity, int requestCode) {
        ...
        File mCameraFile = new File(ConstantsPool.FILE_ROOT, System.currentTimeMillis() + ".jpg");
        //noinspection ResultOfMethodCallIgnored
        Uri uri;
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(activity, "com.liangyibang.lyb.fileprovider", mCameraFile);
        } else {
